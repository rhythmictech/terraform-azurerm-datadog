variable "subscription_id" {
  description = "Azure subscription id for the azurerm provider (mandatory on azurerm v4) and the Activity Log scope."
  type        = string
}

variable "region" {
  description = "Azure region for the forwarder that provides the storage destination."
  type        = string
  default     = "eastus"
}
